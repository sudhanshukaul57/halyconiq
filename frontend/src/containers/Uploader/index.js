...
function Uploader(){
    ...
    const[consolidateFlag, setConsolidateFlag] = useState(false)
    return (
        <div className="body" >
        {!consolidateFlag && 
            <main >
            ...
            <button type="submit" className='upload-button' onClick={() => setConsolidateFlag(true)}>Consolidate Data</button>
